...
// P2-E1: sadržaj FAQ-a (kategorije + ugrađena pitanja) izdvojen iz QAPage.
// Ugrađeni podaci su fallback dok tabela `faq` nije popunjena (seed skripta
// server/scripts/seedFaq.js) i izvor za generisanje seed-a.
