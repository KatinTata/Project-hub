  ...
  return (
    <div style={{ padding: '8px 10px' }} title={title}>
      <div style={{ display: 'flex', justifyContent: 'space-between', gap: 6, alignItems: 'baseline' }}>
        <span style={{ fontFamily: "'DM Mono'", fontSize: 12, fontWeight: 600, color: 'var(--text)' }}>{Math.round(donePct)}%</span>
        <span style={{ fontFamily: "'DM Mono'", fontSize: 11, color: bColor }}>{budgetLabel(plan, spent)}</span>
      </div>
  ...
  return (
    <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 12, overflow: 'hidden' }}>
      ...
      <div style={{ padding: '14px 16px', borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', gap: 10, flexWrap: 'wrap' }}>
        <div>
          <div style={{ fontFamily: 'Syne', fontWeight: 700, fontSize: 14, color: 'var(--text)' }}>Stekovi — napredak po fazama</div>
        ...
        <div style={{ fontFamily: "'DM Mono'", fontSize: 12, color: 'var(--textMuted)', textAlign: 'right' }}>
