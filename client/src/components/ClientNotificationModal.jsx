      ...
      <div style={{
        ...
        <div style={{ padding: '20px 24px', borderBottom: '1px solid var(--border)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 4 }}>
            ...
            <h2 style={{ fontFamily: 'Hanken Grotesk', fontWeight: 800, fontSize: 18, color: 'var(--text)' }}>
              {count === 1 ? t('clientNotif.message1') : count < 5 ? t('clientNotif.message2') : t('clientNotif.message5')}
            </h2>
          </div>
          <p style={{ fontFamily: "'Hanken Grotesk', -apple-system, BlinkMacSystemFont, sans-serif", fontSize: 13, color: 'var(--textMuted)', marginLeft: 34 }}>
          ...
          {notifications.map(n => (
            <div key={n.id} style={{ padding: '12px 24px', borderBottom: '1px solid var(--border)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 4, flexWrap: 'wrap' }}>
                <span style={{ fontFamily: 'Hanken Grotesk', fontSize: 12, fontWeight: 700, color: 'var(--accent)' }}>
              ...
              <p style={{ fontFamily: "'Hanken Grotesk', -apple-system, BlinkMacSystemFont, sans-serif", fontSize: 13, color: 'var(--textMuted)', lineHeight: 1.5 }}>
        ...
        <div style={{ padding: '16px 24px', display: 'flex', gap: 10 }}>
          <button
            onClick={onOpenChat}
            style={{ flex: 1, background: 'var(--accent)', color: '#fff', border: 'none', borderRadius: 8, padding: '10px', fontFamily: "'Hanken Grotesk', -apple-system, BlinkMacSystemFont, sans-serif", fontWeight: 600, fontSize: 14, cursor: 'pointer' }}
          >
            {t('clientNotif.viewAll')} →
          </button>
          <button
            onClick={onClose}
            style={{ background: 'transparent', color: 'var(--textMuted)', border: '1px solid var(--border)', borderRadius: 8, padding: '10px 16px', fontFamily: "'Hanken Grotesk', -apple-system, BlinkMacSystemFont, sans-serif", fontSize: 14, cursor: 'pointer' }}
          >
            {t('clientNotif.close')}
          </button>
        </div>
